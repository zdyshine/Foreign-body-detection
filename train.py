...
def main():
    ...
    valset = dataset.TestDataset(root=args.valroot, transform=transform['val_test'], Label = True)
    val_loader = data.DataLoader(valset, batch_size=args.test_batch, shuffle=True, num_workers=args.workers,
                                 pin_memory=True)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('train_loss:%f, val_loss:%f, train_acc:%f, train_5:%f, val_acc:%f, val_5:%f' % (
